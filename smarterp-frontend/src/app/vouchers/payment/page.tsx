  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 py-4 font-mono">
      <div className="border-b border-slate-800 pb-3 flex justify-between items-center">
        <div>
          <h1 className="text-xl font-bold text-teal-400">Payment Voucher (F5)</h1>
          <p className="text-slate-500 text-[10px] uppercase mt-1">Record cash/bank payments to parties</p>
        </div>
        <button
      ...
      <div className="bg-slate-900 border border-amber-700/40 rounded-lg p-8 text-center space-y-4">
        ...
        <p className="text-slate-500 text-sm">
          Payment Voucher module is not yet implemented in this version.
          <br />
          Use <span className="text-teal-400 font-bold">Purchase Voucher (F9)</span> for supplier payments
          or <span className="text-teal-400 font-bold">Sales Voucher (F8)</span> for customer billing.
        </p>
        <button
          onClick={() => router.push("/dashboard")}
